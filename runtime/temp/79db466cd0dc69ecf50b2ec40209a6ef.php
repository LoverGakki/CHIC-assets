<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"D:\work\WAR_investment\code\public/../application/admin\view\project\investment_project\add.html";i:1685602957;s:70:"D:\work\WAR_investment\code\application\admin\view\layout\default.html";i:1671020443;s:67:"D:\work\WAR_investment\code\application\admin\view\common\meta.html";i:1671020443;s:69:"D:\work\WAR_investment\code\application\admin\view\common\script.html";i:1671020443;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-project_type_id" data-rule="required" data-source="project/project_type/selectpage"
                   ...
                   class="form-control selectpage" name="row[project_type_id]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-head_img" data-rule="required" class="form-control" size="35" name="row[head_img]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-label_ids" data-rule="" data-source="project/project_label/selectpage"
                   ...
                   class="form-control selectpage" name="row[label_ids]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[rebate_method]', ['1'=>__('日返'), '2'=>__('月返'), '3'=>__('定期返')]); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-month_rebate_daily" data-rule="" class="form-control" name="row[month_rebate_daily]" type="number" value="1">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-recurring_rebate_interval_date" data-rule="" class="form-control"
                   name="row[recurring_rebate_interval_date]" type="number" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[dividend_method]', ['1'=>__('本息同返'), '2'=>__('先息后本'), '3'=>__('本息定期同返')]); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-guarantor_institutions" data-rule="required" class="form-control" name="row[guarantor_institutions]"
                   type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea class="form-control editor" data-rule="required" id="project_detail" name="row[project_detail]"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea class="form-control editor" data-rule="required" id="project_information" name="row[project_information]"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[can_use_coupons]', ['1'=>__('能'), '0'=>__('不能')]); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_give_coupons]', [ '0'=>__('否'), '1'=>__('是')]); ?>
        </div>
    </div>

    <!--优惠券配置-->
    <div id="coupons_config" style="display: none">
        <div class="form-group">
            <label for="c-give_coupons_times" class="control-label col-xs-12 col-sm-2">赠送优惠券次数:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-give_coupons_times" data-rule="" class="form-control" name="row[give_coupons_times]" type="number" value="1">
            </div>
        </div>
        <div class="form-group">
            <label for="c-give_coupons_amount" class="control-label col-xs-12 col-sm-2">赠送优惠券金额:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-give_coupons_amount" data-rule="" class="form-control" name="row[give_coupons_amount]" type="number" value="">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input id="c-give_coupons_can_use_project_type" data-rule="" data-source="project/project_type/selectpage"
                       data-field="type_name" data-search-field="type_name" data-primary-key="id" data-pagination="true"
                       data-order-by="id" data-multiple="false" data-params='{"custom[status]":"1"}'
                       class="form-control selectpage" name="row[give_coupons_can_use_project_type]" type="text" value="">
            </div>
        </div>
        <div class="form-group">
            <label for="c-give_coupons_use_limit" class="control-label col-xs-12 col-sm-2">优惠券可使用最低投资金额:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-give_coupons_use_limit" data-rule="" class="form-control" name="row[give_coupons_use_limit]" type="number" value="">
            </div>
        </div>
        <div class="form-group">
            <label for="c-give_coupons_valid_days" class="control-label col-xs-12 col-sm-2">优惠券有效天数:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-give_coupons_valid_days" data-rule="" class="form-control" name="row[give_coupons_valid_days]" type="number" value="">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[can_change_rebates_rate]', [ '0'=>__('不能'), '1'=>__('能')]); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">是否有三级分销奖励:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[can_distribution_rebate]', [ '0'=>__('否'), '1'=>__('是')]); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Status'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['1'=>__('启用'), '0'=>__('关闭')]); ?>
        </div>
    </div>

...
function number_get_value($number, $multiple = 10000)
{
    return intval($number * $multiple) / $multiple;
}


function CurlPost($url, $post, $is_json = false, $timeout = 30, $header = [])
{
    $ch = curl_init();
...
//        }
        /*curl_setopt($ch, CURLOPT_HTTPHEADER, [
                "Content-Type: application/json; charset=utf-8",
                "Content-Length: " . strlen($data_string),
                "access_token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJuYmYiOjE2Mjg1ODAxMTgsImV4cCI6MTYzMTE3MjExOCwic3ViIjoiNjE5MTM1NiIsImF1ZCI6ImFjYWM5NmU2MTY1NGNjNGI4YjRkNjlmZDRjYTA2NmFiIn0.VTvXB2ue6M8IW-IlOvTJw68m4lUGbnsiK7SndP2VPkE"
            ]
        );*/
    } else {
